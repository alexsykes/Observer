...
$sql = "SELECT t.id as id, courselist, club, date, eventname, name, classlist FROM up93k_entryman_trial AS t LEFT JOIN up93k_entryman_venue AS v ON t.venue_id = v.id WHERE t.id = $id";
...
$stmt->bind_result($id, $courselist, $club, $date, $eventname, $name, $classlist);
